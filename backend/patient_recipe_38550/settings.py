"""
Django settings for patient_recipe_38550 project.
...
ROOT_URLCONF = 'patient_recipe_38550.urls'
...
WSGI_APPLICATION = 'patient_recipe_38550.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_recipe_38550 API",
    "DESCRIPTION": "API documentation for patient_recipe_38550 App",
    "VERSION": "v1",
}
