...
## Project Structure
    ...
    ├── patient_recipe_38550  # Django project configurations
...
1. Clone this repo and `cd patient_recipe_38550`
...
2. Clone this repo and `cd patient_recipe_38550`
